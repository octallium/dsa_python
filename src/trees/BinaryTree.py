...
values = [10, 20, 30, 40, 50, -1, 60, 70, -1, -1, -1, -1, -1, -1, 80]
...
print("Count", len(tree.post_order_traversal()))
print("Height", tree.height())
print("Leaf", tree.count_leaf())

# print("In order:", tree.in_order_traversal())
# print("Post order:", tree.post_order_traversal())

v = [8, 3, 5, 4, 9, 7, 2]
t = BinaryTree.from_list(v)
print(t.pre_order_traversal())
print(t.level_order_traversal())
print(t.count_leaf())
